...
namespace GroupSpace23.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Index(string userName, string firstName, string lastName, string email)
        {
            ...
            List<GroupSpace23User> users = _context.Users
            ...
            foreach (GroupSpace23User user in users)
            {
        ...
        {
            GroupSpace23User user = _context.Users.FirstOrDefault(u => u.UserName == userName);
        ...
        {
            GroupSpace23User user = _context.Users.FirstOrDefault(u => u.UserName == _model.UserName);
